    ...
    <>
      ...
      <main id="main">
        ...
        <section className="news-section section" id="noticias">
          <div className="container">
            <header className="section-head reveal">
              <p className="eyebrow">Parcerias &amp; Ações</p>
            ...
            <div className="news-more reveal" style={{ marginTop: 32, textAlign: 'center' }}>
              <Link href="/parcerias" className="btn btn-dark">
          ...
          <div className="footer-top">
            ...
            <div className="footer-cols">
              <div className="footer-col">
                <h5>Institucional</h5>
                <ul><li><a href="#sobre">Quem somos</a></li><li><a href="#projetos">Projetos</a></li><li><a href="#impacto">Impacto</a></li><li><Link href="/parcerias">Parcerias</Link></li></ul>
              </div>
              <div className="footer-col">
                <h5>Apoiar</h5>
